...
ac_shots <- filter(Shots,Team=="Asheville City")
opponent_shots<- filter(Shots,Team!="Asheville City")
...
ac_player_shots<-ac_shots%>%
  group_by(Shooting_Player)%>% ##group by player
  count(Shooting_Player,name="Shot Count") ##tally
